This project utilizes Machine Learning techniques, specifically Linear Regression, to predict the price of a car based on various features such as brand, fuel type, age, mileage, and more. 
